...
function p {
	...
	cp -r tilesets/$1/$V/raw/* raw/
	cp -r tilesets/$1/$V/raw/graphics out-$V/tileset-$1/
	node diff.js raw tilesets/$1/$V/data/init > out-$V/tileset-$1/raw.json
	cp tilesets/$1/$V/data/init/colors.txt out-$V/tileset-$1/
	cp tilesets/$1/$V/data/init/colors-*.txt out-$V/tileset-$1/
	cp "tilesets/$1/$V/data/art/$2" out-$V/tileset-$1/tileset.png
	cp tilesets/$1/$V/manifest.json out-$V/tileset-$1/
